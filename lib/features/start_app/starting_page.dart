      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 35,),
            FilledButton(onPressed: (){},style: ButtonStyle(backgroundColor: WidgetStatePropertyAll(AppColor.mainRedColor),fixedSize: WidgetStatePropertyAll(Size(170,40))), child: Text("Get Start",style: TextStyle(fontSize: 18),),)
          ],
        ),
      ),
    );
