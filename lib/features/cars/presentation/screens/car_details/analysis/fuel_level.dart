...
class FuelLevelScreen extends StatefulWidget {
  const FuelLevelScreen({
    super.key,
    required this.car,
  });
  final CarEntity car;
  @override
  State<FuelLevelScreen> createState() => _FuelLevelScreenState();
}

class _FuelLevelScreenState extends State<FuelLevelScreen> {
