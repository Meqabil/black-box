...
class RoadBumpScreen extends StatefulWidget {
  const RoadBumpScreen({
    super.key,
    required this.car,
  });
  final CarEntity car;
  @override
  State<RoadBumpScreen> createState() => _RoadBumpScreenState();
}

class _RoadBumpScreenState extends State<RoadBumpScreen> {
