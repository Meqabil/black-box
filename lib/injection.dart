...
import 'package:black_box/features/crashes/data/repositories/crash_repository_impl.dart';
...
import 'package:black_box/features/trips/data/repositories/trip_repository_impl.dart';
...
import 'features/crashes/domain/repositories/crash_repository.dart';
...
import 'features/notifications/domain/usecases/make_as_read_usecase.dart';
...
Future<void> initAuthFeature() async{
  ...
  s1.registerLazySingleton(() => CheckNotificationsUseCase(s1()));
  s1.registerLazySingleton(() => MakeAsReadUseCase(s1()));
  ...
  s1.registerLazySingleton(() => ShowTripDetailUseCase(s1()));
  s1.registerLazySingleton(() => ShowTripsHistoryUseCase(s1()));
  ...
  s1.registerLazySingleton<TripRepository>(() => TripRepositoryImpl(s1()));
  ...
  s1.registerLazySingleton(() => TripDataSource());
